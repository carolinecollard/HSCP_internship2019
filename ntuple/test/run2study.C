...
//
void run2study::Loop(int year, TString Letter, bool dataFlag=true)
{
...
// histograms
   ...
   TH2D* dEdXpixVsP_lowp = new TH2D("dEdXpixVsP_lowp", "dEdX:P", 50,0,5, 50, 2.,7.);
   TH2D* dEdXpixVsP_lowp2 = new TH2D("dEdXpixVsP_lowp2", "dEdX:P", 125,0,25, 50, 2.,7.);
   ...
   TH2D* dEdXstripVsP_lowp2 = new TH2D("dEdXstripVsP_lowp2", "dEdX:P", 125,0,25, 50, 2.,7.);
   TH2D* dEdX0VsP_lowp = new TH2D("dEdX0VsP_lowp", "dEdX:P", 50,0,5, 50, 2.,7.);
   TH2D* dEdX0VsP_lowp2 = new TH2D("dEdX0VsP_lowp2", "dEdX:P", 125,0,25, 50, 2.,7.);
   TH2D* dEdX0stripVsP_lowp = new TH2D("dEdX0stripVsP_lowp", "dEdX:P", 50,0,5, 50, 2.,7.);
   TH2D* dEdX0stripVsP_lowp2 = new TH2D("dEdX0stripVsP_lowp2", "dEdX:P", 125,0,25, 50, 2.,7.);
   TH2D* dEdX0noL1VsP_lowp = new TH2D("dEdX0noL1VsP_lowp", "dEdX:P", 50,0,5, 50, 2.,7.);
   TH2D* dEdX0noL1VsP_lowp2 = new TH2D("dEdX0noL1VsP_lowp2", "dEdX:P", 125,0,25, 50, 2.,7.);
   TH2D* dEdX0noL1VsP_eta1_lowp = new TH2D("dEdX0noL1VsP_eta1_lowp", "dEdX:P", 50,0,5, 50, 2.,7.);
   TH2D* dEdX0noL1VsP_eta1_lowp2 = new TH2D("dEdX0noL1VsP_eta1_lowp2", "dEdX:P", 125,0,25, 50, 2.,7.);
   TH2D* dEdX0noL1VsP_eta2_lowp = new TH2D("dEdX0noL1VsP_eta2_lowp", "dEdX:P", 50,0,5, 50, 2.,7.);
   TH2D* dEdX0noL1VsP_eta2_lowp2 = new TH2D("dEdX0noL1VsP_eta2_lowp2", "dEdX:P", 125,0,25, 50, 2.,7.);
   TH2D* dEdX0noL1VsP_eta3_lowp = new TH2D("dEdX0noL1VsP_eta3_lowp", "dEdX:P", 50,0,5, 50, 2.,7.);
   TH2D* dEdX0noL1VsP_eta3_lowp2 = new TH2D("dEdX0noL1VsP_eta3_lowp2", "dEdX:P", 125,0,25, 50, 2.,7.);
   TH2D* dEdX0noL1VsP_pu1_lowp = new TH2D("dEdX0noL1VsP_pu1_lowp", "dEdX:P", 50,0,5, 50, 2.,7.);
   TH2D* dEdX0noL1VsP_pu1_lowp2 = new TH2D("dEdX0noL1VsP_pu1_lowp2", "dEdX:P", 125,0,25, 50, 2.,7.);
   TH2D* dEdX0noL1VsP_pu2_lowp = new TH2D("dEdX0noL1VsP_pu2_lowp", "dEdX:P", 50,0,5, 50, 2.,7.);
   TH2D* dEdX0noL1VsP_pu2_lowp2 = new TH2D("dEdX0noL1VsP_pu2_lowp2", "dEdX:P", 125,0,25, 50, 2.,7.);
   TH2D* dEdX0noL1VsP_pu3_lowp = new TH2D("dEdX0noL1VsP_pu3_lowp", "dEdX:P", 50,0,5, 50, 2.,7.);
   TH2D* dEdX0noL1VsP_pu3_lowp2 = new TH2D("dEdX0noL1VsP_pu3_lowp2", "dEdX:P", 125,0,25, 50, 2.,7.);
   TH2D* dEdX0noL1VsP_pu4_lowp = new TH2D("dEdX0noL1VsP_pu4_lowp", "dEdX:P", 50,0,5, 50, 2.,7.);
   TH2D* dEdX0noL1VsP_pu4_lowp2 = new TH2D("dEdX0noL1VsP_pu4_lowp2", "dEdX:P", 125,0,25, 50, 2.,7.);
   TH2D* dEdXHDnoL1VsP_lowp = new TH2D("dEdXHDnoL1VsP_lowp", "dEdX:P", 50,0,5, 50, 2.,7.);
   TH2D* dEdXHDnoL1VsP_lowp2 = new TH2D("dEdXHDnoL1VsP_lowp2", "dEdX:P", 125,0,25, 50, 2.,7.);
   TH2D* dEdX0pixnoL1VsP_lowp = new TH2D("dEdX0pixnoL1VsP_lowp", "dEdX:P", 50,0,5, 50, 2.,7.);
   TH2D* dEdX0pixnoL1VsP_lowp2 = new TH2D("dEdX0pixnoL1VsP_lowp2", "dEdX:P", 125,0,25, 50, 2.,7.);
...
//   TString outputfilename="analysis_rereco";
   ...
   outputfilename+="_wSF_17jan.root";
   ...
   templateFileName+="_wSF_17jan.root";
   TFile* OutputTemplate = new TFile(templateFileName,"RECREATE");
...
//             if (track_pt[hscp_track_idx[ihs]]<5) selection=false;
             ...
             //if (track_pterr[hscp_track_idx[ihs]]/track_pt[hscp_track_idx[ihs]]>0.25) selection=false; // commented on September 22, 2021
...
//                      // with Saturation only (but no Xtalk inversion) :
                          ...
                          float newcharge =0;
                          for (int inwc=0; inwc<Qcor.size(); inwc++) { newcharge+=Qcor[inwc]; }
                          ch1=newcharge;
                    ...
                    HSCP_nmpix->Fill(charge_corr2.size());
                    if (charge_corr1.size()>0) HSCP_nmratio->Fill(charge_corr2.size()*1./charge_corr1.size());
                    ...
                    dEdX0NoL1VsRun->Fill(runNumber,ih0_noL1);
...
*/
                    ...
                    float mass_strip=-1;
                    if (ih_LDstrip - Cval>0) mass_strip=sqrt((ih_LDstrip - Cval)*track_p[hscp_track_idx[ihs]]*track_p[hscp_track_idx[ihs]]/Kval);
                    ...
                    float mass_ih=-1;
                    if (ih_LD - Cval>0) mass_ih=sqrt((ih_LD - Cval)*track_p[hscp_track_idx[ihs]]*track_p[hscp_track_idx[ihs]]/Kval);
                    ...
                    float mass_ih0=-1;
                    if (ih0_cor - Cval>0) mass_ih0= sqrt((ih0_cor - Cval)*track_p[hscp_track_idx[ihs]]*track_p[hscp_track_idx[ihs]]/Kval);
                    ...
                    if (ih0_noL1 - Cval>0) mass_ih0noL1= sqrt((ih0_noL1 - Cval)*track_p[hscp_track_idx[ihs]]*track_p[hscp_track_idx[ihs]]/Kval);

                    Cval = 3.385;
                    Kval = 2.136;
                    if (dataFlag) { // not yet up-to-date...
                      Cval = 3.242 ;
                      Kval = 2.173 ;
                    }
                    float mass_0strip=-1;
                    if (ih0_strip - Cval>0) mass_0strip= sqrt((ih0_strip - Cval)*track_p[hscp_track_idx[ihs]]*track_p[hscp_track_idx[ihs]]/Kval);
                    ...
                    if (ih_corHiDropNoL1 - Cval>0) mass_ihHDnoL1= sqrt((ih_corHiDropNoL1 - Cval)*track_p[hscp_track_idx[ihs]]*track_p[hscp_track_idx[ihs]]/Kval);
                    ...
                    float mass_pixel=-1;
                    if (ih_LDpix - Cval>0) mass_pixel= sqrt((ih_LDpix - Cval)*track_p[hscp_track_idx[ihs]]*track_p[hscp_track_idx[ihs]]/Kval);
                    Cval = 3.226;
                    Kval = 1.782;
                    if (dataFlag) { // not yet up-to-date...
                      Cval = 3.242 ;
                    ...
                    float mass_pixnL1=-1;
                    if (ih0_noL1pix - Cval>0) mass_pixnL1= sqrt((ih0_noL1pix - Cval)*track_p[hscp_track_idx[ihs]]*track_p[hscp_track_idx[ihs]]/Kval);



                    bool blind_data=false;

                    if (dataFlag && mass_ih0noL1>800) blind_data=true;
                    ...
                    if (!blind_data) {
                      ...
                      HSCP2d_MassIhstrip->Fill(track_p[hscp_track_idx[ihs]],mass_strip);
                      HSCP2d_MassIh->Fill(track_p[hscp_track_idx[ihs]],mass_ih);
                      HSCP2d_MassIh0->Fill(track_p[hscp_track_idx[ihs]],mass_ih0);
                      HSCP2d_MassIh0noL1->Fill(track_p[hscp_track_idx[ihs]],mass_ih0noL1);
                      HSCP2d_MassIh0strip->Fill(track_p[hscp_track_idx[ihs]],mass_0strip);
                      HSCP2d_MassIhHDnoL1->Fill(track_p[hscp_track_idx[ihs]],mass_ihHDnoL1);
...
//          cout << " debug loop tracks "  << itr << endl;
         ...
         //additional selection (September 22, 2021)
         if (abs(track_eta[itr])>2.1) continue;
         if (track_npixhits[itr]<2) continue;
         //
...
//               cout << " debug loop iclu "  << iclu << endl;
               float ch1=dedx_charge[iclu];
               bool clean1=true;
               if (dedx_subdetid[iclu]>=3) {
                        // strip
...
//                      // with Saturation only (but no Xtalk inversion) :
              ...
              if (dedx_ispixel[iclu]) {
                  ...
                  if (no_in_L1_pixel) {
                   ...
                   if (track_p[itr]>5 && track_p[itr]<45) Charge_Vs_Path_noL1->Fill (dedx_modulgeom[iclu], dedx_pathlength[iclu]*10, scaleFactor*ch1/(dedx_pathlength[iclu]*10*norm_mult),presk);
                  }
                  if (track_p[itr]>5 && track_p[itr]<45) Charge_Vs_Path->Fill (dedx_modulgeom[iclu], dedx_pathlength[iclu]*10, scaleFactor*ch1/(dedx_pathlength[iclu]*10*norm_mult),presk);
              }
              else {
                  double ChargeOverPathlength = scaleFactor*Norm*ch1;
		  if (dedx_pathlength[iclu]>0) ChargeOverPathlength/=dedx_pathlength[iclu];
         ...
         double ih0_npixoL1 = getdEdX(charge_corr4, pathlength4, subdetId4, moduleGeometry4, bool_cleaning4, mustBeInside4, dEdxSF, NULL,2, 0., nv, ns);
         ...
         if (track_p[itr]<20) {
//            dEdXVsP_lowp2->Fill(track_s[itr],track_ih_ampl[itr],presk);
//            dEdXVsP_lowp3->Fill(track_p[itr],track_ih_ampl[itr],presk);
            dEdXVsP_lowp2->Fill(track_p[itr],ih_cor,presk);
            dEdXVsP_lowp3->Fill(track_p[itr],ih_cor,presk);
            ...
            dEdX0pixnoL1VsP_lowp2->Fill(track_p[itr],ih0_npixoL1,presk);
         }
         if (track_p[itr]<5) {
...
//          dEdXVsP_lowp->Fill(track_p[itr],track_ih_ampl[itr],presk);
            ...
            dEdX0pixnoL1VsP_lowp->Fill(track_p[itr],ih0_npixoL1,presk);
            ...
            if (track_p[itr]<3) {
                    ...
                    float mass_strip=-1;
                    if (ih_strip - Cval>0.5) mass_strip=sqrt((ih_strip - Cval)*track_p[itr]*track_p[itr]/Kval);
                    ...
                    float mass_ih=-1;
                    if (ih_cor - Cval>0.5) mass_ih=sqrt((ih_cor - Cval)*track_p[itr]*track_p[itr]/Kval);
                    ...
                    float mass_ih0=-1;
                    if (ih0_cor - Cval>0.5) mass_ih0= sqrt((ih0_cor - Cval)*track_p[itr]*track_p[itr]/Kval);
                    ...
                    float mass_ih0noL1=-1;
                    if (ih0_noL1 - Cval>0.5) mass_ih0noL1= sqrt((ih0_noL1 - Cval)*track_p[itr]*track_p[itr]/Kval);
                    ...
                    float mass_0strip=-1;
                    if (ih0_strip - Cval>0.5) mass_0strip= sqrt((ih0_strip - Cval)*track_p[itr]*track_p[itr]/Kval);

                    Cval = 3.208; 
                    Kval = 2.013; 
                    float mass_ihHDnoL1=-1;
                    if (ih_corHiDropNoL1 - Cval>0.5) mass_ihHDnoL1= sqrt((ih_corHiDropNoL1 - Cval)*track_p[itr]*track_p[itr]/Kval);

                    Cval = 3.116;
                    Kval = 1.871;
                    float mass_pixel=-1;
                    if (ih_pix - Cval>0) mass_pixel= sqrt((ih_pix - Cval)*track_p[itr]*track_p[itr]/Kval);

                    Cval = 3.226;
                    Kval = 1.782;
                    float mass_pixnL1=-1;
                    if (ih0_npixoL1 - Cval>0) mass_pixnL1= sqrt((ih0_npixoL1 - Cval)*track_p[itr]*track_p[itr]/Kval);
                    ...
                    lowp_dEdXpixVsstrip->Fill(ih_strip,ih_pix);
                    lowp_dEdX0pixVsstrip->Fill(ih0_strip,ih0_npixoL1);
                    lowp2d_Mass_pix_strip15->Fill(mass_strip,mass_pixel);
                    lowp2d_Mass_pix_strip0->Fill(mass_0strip,mass_pixnL1);
                    if (mass_0strip>0 && mass_pixnL1>0 ) {
                      lowp_MassDiff_pix_strip0->Fill(mass_0strip - mass_pixnL1);
                    }
                    if (mass_strip>0 && mass_pixel>0) {
                      lowp_MassDiff_pix_strip15->Fill(mass_strip - mass_pixel);
                    }
              }
...
//          for (int h=0; h<charge_corr1.size(); h++) {   //only strip
          for (int h=0; h<charge_corr.size(); h++) {      //all cluster
...
//          dEdXstripVsNhittrunc_lowp->Fill(vect.size()-nTrunc,ih_strip,presk);
         ...
         if (track_p[itr]<5) {
           if (ih_cor<3.4) NPixVsNStrip_lowIhp->Fill(nstrip,npix,presk);
           else if (ih_cor>3.5) NPixVsNStrip_highIhp->Fill(nstrip,npix,presk);
...
//         Htrackih->Fill(track_ih_ampl[itr]);
         Htrackih->Fill(ih_cor);
//         dEdXVsP->Fill(track_p[itr],track_ih_ampl[itr]);
         dEdXVsP->Fill(track_p[itr],ih_cor);
...
double run2study::getdEdX(std::vector <float> charge, std::vector <float> pathlength, std::vector <int> subdetId, std::vector <int> moduleGeometry, std::vector <bool> bool_cleaning, std::vector <bool> mustBeInside, double* scaleFactors, TH3* templateHisto, int n_estim, double dropLowerDeDxValue, double dropHigherDeDxValue, int & nv, int & ns) {
  double result=-1;
...
float run2study::FMIP(std::vector <float> charge, std::vector <float> path, float SFactor, float thre = 4){
...
void run2study::loadSFPixelTamas() {
...
float run2study::GetSFPixelTamas(int subdetid_, UInt_t detid_, int year, int run) {
...
std::vector<int> run2study::SaturationCorrection(const std::vector<int>&  Q, const float x1, const float x2, bool way,float threshold,float thresholdSat) {
...
bool run2study::clusterCleaning(const std::vector<int>&  Q, int crosstalkInv, uint8_t * exitCode)
{
     vector<int>  ampls = Q;
